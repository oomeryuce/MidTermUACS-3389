...
using MidTerm.Data.Concrete;
using MidTerm.Services.Abstract;
using MidTerm.Services.Concrete;

namespace MidTerm.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<ISurveyUserService, SurveyUserService>();
            services.AddSingleton<ISurveyUserDal, EfSurveyUserDal>();
